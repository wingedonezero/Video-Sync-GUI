...
from .tabs import BaseTab, StylesTab, FilteringTab, FontsTab
...
class TabPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._current_tab: Optional[BaseTab] = None
