...
def build_options_modal():
    ...
    with dpg.window(tag="options_modal", label="Preferences", width=860, height=600, modal=True, show=False,
                    pos=(120, 80)):
        with dpg.tab_bar():
            # Storage
            ...
            with dpg.tab(label="Global"):
                ...
                _row_check("Make first subtitle in final order the DEFAULT", "op_first_sub_def", "first_sub_default",
