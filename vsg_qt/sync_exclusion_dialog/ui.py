...
class SyncExclusionDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        info_label.setStyleSheet(
            "font-weight: bold; padding: 10px; background-color: #f0f0f0; color: #000000;"
        )
        ...
        help_label.setStyleSheet(
            "padding: 10px; background-color: #ffffcc; color: #000000;"
        )
        ...
        self.include_radio = QRadioButton(
    ...
    def _load_styles(self):
        ...
        subtitle_path = (
            self.track_data.get("original_path")
            or self.track_data.get("user_modified_path")
            or self.track_data.get("extracted_path")
        )
        ...
        try:
            ...
            if not self.style_counts:
                ...
                self.preview_label.setStyleSheet(
                    "font-weight: bold; padding: 10px; color: #FFA500;"
                )
                return
    ...
    def _get_selected_styles(self):
        ...
        return [
            style_name
            for style_name, checkbox in self.style_checkboxes.items()
    ...
    def _update_preview(self):
        ...
        if not selected_styles:
            self.preview_label.setText(
                "⚠️ No styles selected - all events will be frame-matched normally"
            )
            self.preview_label.setStyleSheet(
                "font-weight: bold; padding: 10px; color: #FFA500;"
            )
    ...
    def _on_accept(self):
        ...
        self.exclusion_config = {
            ...
            "original_style_list": sorted(
                self.style_counts.keys()
