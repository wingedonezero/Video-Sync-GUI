...
# ---- small helpers for composite inputs (same UX as before) ----
...
class StorageTab(QWidget):
    """Output folder, temp dir, optional videodiff path."""
    def __init__(self):
        super().__init__()
...
class AnalysisTab(QWidget):
    """Analysis mode + audio/video thresholds and language picks."""
    def __init__(self):
        super().__init__()
        self.widgets: Dict[str, QWidget] = {}
        f = QFormLayout(self)
        ...
        # Language hints
        self.widgets['analysis_lang_ref'] = QLineEdit(); self.widgets['analysis_lang_ref'].setPlaceholderText('Blank = first available')
        ...
        f.addRow('TER Language:', self.widgets['analysis_lang_ter'])

class ChaptersTab(QWidget):
    """Chapter rename + snapping options."""
    def __init__(self):
        super().__init__()
        self.widgets: Dict[str, QWidget] = {}
        f = QFormLayout(self)
...
class MergeBehaviorTab(QWidget):
    """Mux flags affecting track stats and dialog normalization."""
    def __init__(self):
        super().__init__()
        self.widgets: Dict[str, QWidget] = {}
        f = QFormLayout(self)
