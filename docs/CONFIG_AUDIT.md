...
| `video_verified_backend` | `str` | `"isc"`, `"sscd_mixup"`, `"sscd_large"`, `"phash"`, `"dhash"`, `"ssim"` | sliding-window matcher |
| `video_verified_cross_check_backend` | `str` | `"none"` + same set as primary | sliding-window matcher |
...
### SubtitleSyncTab
`subtitle_sync_mode`, `subtitle_rounding`, `time_based_use_raw_values`, `duration_align_validate`, `duration_align_validate_points`, `duration_align_strictness`, `duration_align_verify_with_frames`, `duration_align_skip_validation_generated_tracks`, `duration_align_fallback_mode`, `frame_lock_submillisecond_precision`, `videotimestamps_snap_mode`, `correlation_snap_fallback_mode`, `sub_anchor_fallback_mode`, `corr_anchor_fallback_mode`, `corr_anchor_refine_per_line`, `corr_anchor_refine_workers`, `video_verified_backend`, `video_verified_cross_check_backend`, `video_verified_cross_check_tolerance_frames`, `video_verified_window_seconds`, `video_verified_slide_range_seconds`, `video_verified_num_positions`, `video_verified_batch_size`, `video_verified_hash_size`, `video_verified_ssim_input_size`, `video_verified_run_in_subprocess`, `video_verified_debug_report`, `video_verified_frame_audit`, `video_verified_visual_verify`, `interlaced_handling_enabled`, `interlaced_force_mode`, `interlaced_hash_algorithm`, `interlaced_hash_size`, `interlaced_hash_threshold`, `interlaced_sequence_length`, `interlaced_num_checkpoints`, `interlaced_search_range_frames`, `interlaced_deinterlace_method`, `interlaced_comparison_method`, `interlaced_use_ivtc`, `interlaced_fallback_to_audio`
