...
class StyleEdit:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for attr in [
            'new_fontname', 'new_fontsize', 'new_primary_color',
            'new_secondary_color', 'new_outline_color', 'new_back_color',
            'new_bold', 'new_italic', 'new_underline',
            'new_scale_x', 'new_scale_y', 'new_spacing', 'new_angle',
            'new_border_style', 'new_outline', 'new_shadow',
            'new_alignment', 'new_margin_l', 'new_margin_r', 'new_margin_v',
        ]:
...
class SubtitleEditPlan:
    ...
    def set_event_edit(self, edit: EventEdit) -> None:
        ...
        self.event_edits = [e for e in self.event_edits if e.event_index != edit.event_index]
        if edit.has_changes():
    ...
    def set_style_edit(self, edit: StyleEdit) -> None:
        ...
        self.style_edits = [s for s in self.style_edits if s.style_name != edit.style_name]
        if edit.has_changes():
    ...
    def add_group(self, group: GroupDefinition) -> None:
        ...
        self.group_definitions = [g for g in self.group_definitions if g.name != group.name]
    ...
    def from_dict(cls, data: dict[str, Any]) -> SubtitleEditPlan:
        ...
        return cls(
            ...
            group_definitions=[GroupDefinition.from_dict(g) for g in data.get('group_definitions', [])],
        )
