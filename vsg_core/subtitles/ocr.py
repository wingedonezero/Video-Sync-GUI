...
Provides the run_ocr function for integration with the subtitle processing pipeline.
This module wraps the new integrated OCR system in vsg_core/subtitles/ocr/.
"""
