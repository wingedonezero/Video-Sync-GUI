...
class PlanItem:
    ...
    font_replacements: dict[str, Any] | None = None  # Font replacement mappings from Font Manager
    ...
    filter_config: dict[str, Any] | None = None  # Filter settings: mode, styles, forced_include, forced_exclude
